        ...
        <TooltipTrigger
          render={
            <Link
              ...
              className="ml-1 flex min-w-0 flex-1 cursor-pointer items-center gap-0 rounded-md outline-hidden ring-ring transition-colors hover:text-foreground focus-visible:ring-2"
              to="/"
            >
              <K3Wordmark />
              ...
              <span className="ml-1 rounded-full bg-muted/50 px-1.5 py-0.5 text-[8px] font-medium uppercase tracking-[0.18em] text-muted-foreground/60">
                {APP_STAGE_LABEL}
              </span>
            </Link>
          }
